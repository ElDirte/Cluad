...
try {
    ...
    Write-Host "  Skipping model pull for now (agent will use Claude for all analysis)" -ForegroundColor Yellow
}
...
Write-Host "  1. Make sure .env has your ANTHROPIC_API_KEY"
Write-Host "  2. Open Eagle"
Write-Host "  3. Double-click start.bat to launch the agent"
Write-Host "`nURLs when running:"
Write-Host "  Agent chat  ->  http://localhost:8000"
Write-Host "  n8n flows   ->  http://localhost:5678"
Write-Host ""
